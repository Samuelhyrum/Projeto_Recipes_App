# :construction: Recipes App ! :construction:
<!-- Olá, Tryber!
...
<details>
 ...
 Eu desenvolvi um app de receitas, utilizando o que há de mais moderno dentro do ecossistema React: Hooks e Context API!
